import { LayoutDashboard, ArrowLeftRight, BarChart3, Calendar, Target, BookOpen } from 'lucide-react'
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
const navItems = [
  ...
  { title: 'Trades', icon: ArrowLeftRight, id: 'trades' },
  { title: 'Analytics', icon: BarChart3, id: 'analytics' },
  { title: 'Calendar', icon: Calendar, id: 'calendar' },
  { title: 'Pre-Market', icon: Target, id: 'premarket' },
